---
title:  rmd/01060_sampling_binom.Rmd
output:
    html_document:
        toc: true 
        toc_depth: 2
...
\tiny{library(ggplot2)}
```
###  Toss coin 100 times, return # SUCCCESSES
```{r rbinom}
...
Raw Data, 0 or 1
sample() returns each outcome, unlike rbinom() which returns total successes
int[n]
Notation:
n = sample size or number of throws
replace
s
```{r sample}
...
```{r render, eval=FALSE  }
rmarkdown::render("rmd/01060_sampling_binom.Rmd",  
