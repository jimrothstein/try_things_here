...
##  but only do calc for .SDcols, and output;  not all columns in .SD
  DT[,lapply(.SD, mean), by  = .(origin, dest, month), .SDcols=c("dep_delay",
                                                                 "arr_delay")]

  ## 
  ## START HERE
  ## note I added carrier!
  DT[,print(.SD), by  = .(carrier), .SDcols = c("dep_delay", "arr_delay",
                                                "carrier")]
  DT[,head(.SD), by  = .(carrier), .SDcols = c("dep_delay", "arr_delay",
                                                "carrier")]
