...
##  TODO: 
##    2023-05-26
-     collect examples from elsewhere
-     str:  review args
-     dput: keep list(...), but remove other output

####	PURPOSE:
str:  THIS IS MAIN COLLECTECTION
...
```
 -------------------------------------------------- 
##  list.len, for sibblings(a one level) number to display
```{r}
L <- list(1, 2, 3, 4, 5)
str(L)
# List of 5
...
##  vec.len TODO
```{r}
str(letters[1:11], vec.len = 3)
#  chr [1:11] "a" "b" "c" ...

str(list(1, 2, letters[1:11], list(1, 2, 3, 4, 5)), vec.len = 3)
# List of 4
#  $ : num 1
#  $ : num 2
#  $ : chr [1:11] "a" "b" "c" ...
