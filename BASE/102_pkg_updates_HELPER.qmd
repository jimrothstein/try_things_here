...
# inner_join
dt_user[dt_sys, on=.(Package == Package), nomatch=NULL][, 1] # 9
dt_sys[dt_user, on=.(Package == Package), nomatch=NULL][, 1] # 9

# !=  is NOT allowed
if false dt1[dt2, on=.(Package != Package)][, 1]

# anti-join, all packages in dt_user, not in dt_sys
dt_user[!dt_sys, on = .(Package)][, 1] # 228

# anti , packages in dt_sys, not in dt_user
dt_sys[!dt_user, on = .(Package)][, 1] # 20
