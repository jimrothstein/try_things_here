...
## first, find candidate packages not memeber of standard library


## next, find candidates packages ARE member of standard libary AND are in user directory AND are in user directory
...
y = x[x[,1] == "KernSmooth",, drop=F]
is.matrix(y)
y
y = x[x[,1] == "KernSmooth",1:6]
y
is.matrix(y)
x[x[,2] == .libPaths()[[2]],]
