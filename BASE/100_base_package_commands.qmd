...
pkg = list()
pkg1 = vector(mode="character")
pkg1 = dplyr::filter(p, LibPath== .libPaths()[[1]])[,1]
pkg1

pkg2 = vector(mode="character")
pkg2= dplyr::filter(p, LibPath== .libPaths()[[2]])[,1]
pkg2
