...
-   ns1, ns2 are both environments, but not the same

```{r}
# <environment: namespace:stats>
ns1 =asNamespace("stats")  # do not prefix with "package:"
ns1
is.environment(ns1) # T 


# package environment PLUS attributes
ns2 = as.environment("package:stats")
ns2
is.environment(ns2)   #T
