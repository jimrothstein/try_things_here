...
### Compare names vs env themself
```{r}
search() # returns strings
search_envs()  # returns envs, in a list?  rlang_env
class(search_envs())  # "rlang_envs" 

one = search_envs()[1]  # returns chain  
search_envs()[[1]]   # return <env>


is_environment(one[1])  # F
is_environment(one[[1]])  # T 

class(search_envs()[1])  # rlang_envs, chain
str(search_envs()[1])
```
