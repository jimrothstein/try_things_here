...
# none of these puts x and value into global env
h01(x <- 100)
h01(x = 100)
h01(100)
a=2
...
h03  <- function(x) {
message("Entered h03 ...")
	c(x,x)                  # When is x evaluated?
}

h03(arg <- double(20))                  # arg = 40 now in global env

h03(double(20))     # When is double(20) evaluated?
ls()
